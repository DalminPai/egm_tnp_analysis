...
baseOutDir = 'results/Moriond17/tnpEleTrig/HN_leg1_v3/' # Heavy-Neutrino leg1 SF job. pu-tree used in ID SF and modified pT bin was used.
...
#   { 'var' : 'el_pt' , 'type': 'float', 'bins': [0,10,15,20,23,25,30,35,45,60,80,120,200,500] },  ## for leg1 trigger
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [10,15,20,25,30,50,90,150,500] },  ## for leg1 trigger modified pT bin
]
