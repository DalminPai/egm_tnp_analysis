...
eosWinter17 = '/home/dmpai/TnPTree/Fabrice/Moriond17_v1/'
myinputDir = '/home/dmpai/TnPTree/Dalmin/HN/Moriond17_GainSwitch_newTnP_v3_test/'
myinputDir_leg1 = '/home/dmpai/TnPTree/Dalmin/HN/Moriond17_GainSwitch_newTnP_v3_leg1/'
myinputDir_leg2 = '/home/dmpai/TnPTree/Dalmin/HN/Moriond17_GainSwitch_newTnP_v3_leg2/'
...
Moriond17_80X_HN = {
    ...
    'data_Run2016B' : tnpSample('data_Run2016B' , myinputDir + 'data/TnPTree_SingleElectron_2016rereco_RunB.root' , lumi = 5.788 ),
    'data_Run2016C' : tnpSample('data_Run2016C' , myinputDir + 'data/TnPTree_SingleElectron_2016rereco_RunC.root' , lumi = 2.573 ),
    'data_Run2016D' : tnpSample('data_Run2016D' , myinputDir + 'data/TnPTree_SingleElectron_2016rereco_RunD.root' , lumi = 4.248 ),
    'data_Run2016E' : tnpSample('data_Run2016E' , myinputDir + 'data/TnPTree_SingleElectron_2016rereco_RunE.root' , lumi = 4.009 ),
    'data_Run2016F' : tnpSample('data_Run2016F' , myinputDir + 'data/TnPTree_SingleElectron_2016rereco_RunF.root' , lumi = 3.102 ),
    'data_Run2016G' : tnpSample('data_Run2016G' , myinputDir + 'data/TnPTree_SingleElectron_2016rereco_RunG.root' , lumi = 7.540 ),
    'data_Run2016H' : tnpSample('data_Run2016H' , myinputDir + 'data/TnPTree_SingleElectron_2016prompt_RunH.root' , lumi = 8.606 ),
    }
...
Moriond17_80X = {
    ...
    'data_Run2016B' : tnpSample('data_Run2016B' , eosWinter17 + 'data/TnPTree_SingleElectron_2016rereco_RunB.root' , lumi = 5.788 ),
    'data_Run2016C' : tnpSample('data_Run2016C' , eosWinter17 + 'data/TnPTree_SingleElectron_2016rereco_RunC.root' , lumi = 2.573 ),
    'data_Run2016D' : tnpSample('data_Run2016D' , eosWinter17 + 'data/TnPTree_SingleElectron_2016rereco_RunD.root' , lumi = 4.248 ),
    'data_Run2016E' : tnpSample('data_Run2016E' , eosWinter17 + 'data/TnPTree_SingleElectron_2016rereco_RunE.root' , lumi = 4.009 ),
    'data_Run2016F' : tnpSample('data_Run2016F' , eosWinter17 + 'data/TnPTree_SingleElectron_2016rereco_RunF.root' , lumi = 3.102 ),
    'data_Run2016G' : tnpSample('data_Run2016G' , eosWinter17 + 'data/TnPTree_SingleElectron_2016rereco_RunG.root' , lumi = 7.540 ),
    'data_Run2016H' : tnpSample('data_Run2016H' , eosWinter17 + 'data/TnPTree_SingleElectron_2016prompt_RunH.root' , lumi = 8.606 ),
