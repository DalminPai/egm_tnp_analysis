...
#        systAltTagSelec = self.altEff[self.iAltTagSelec] - averageEffData
        ...
        for isyst in range(2):  # control which uncertainties are used
    ...
    def __add__(self,eff):
        ...
        effout = efficiency_ErrBar(ptbin,etabin,newEffData,newErrEffData,newEffMC,newErrEffMC,newEffAltBkgModel,newEffAltSigModel,newEffAltMCSignal,newEffAltTagSelec)
        return effout
